...
classifier= ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/996mFkyjO/model.json",model_loaded);
    ...
    if(error){
       ...
       console.log(results);
        ...
        if(results[0].label=="Crying"){
            document.getElementById("result_emoji1").innerHTML="&#128546";
        }
